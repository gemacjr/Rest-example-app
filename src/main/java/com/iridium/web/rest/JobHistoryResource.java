...
import com.iridium.domain.JobHistory;
import com.iridium.repository.JobHistoryRepository;
import com.iridium.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.iridium.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "iwsRestInternalJobHistory";
